...
if (isset($_SESSION['id_user'])) {
    ...
    if (isset($_POST['id_publication']) && isset($_POST['id_commentaire']) && isset($_POST['fichier']) && is_numeric($_POST['id_publication'])) {
        ...
        $sql = "DELETE FROM reaction_commentaire WHERE id_commentaire = $id_commentaire AND id_compte = $id_user";
        ...
        if ($result) {
            ...
            if (mysqli_affected_rows($conn) > 0) {
                ...
                $sql_insert = "INSERT INTO reaction_commentaire (id_commentaire, id_compte, id_reaction) 
                               VALUES ($id_commentaire, $id_user, 1)";
